...
async def gen_thumb(videoid, user_id):
    try:
        ...
        if 1==1:
            ...
            image4.text((30, 30), "L2R MUSIC", fill="white", font = font1, align ="left")
            image4.text((770, 250), "NOW PLAYING", fill="white", font = font2, stroke_width=2, stroke_fill="white", align ="left") 
            # title
